const allPermissions = [
  ...
  ['recado-equipe.ver', 'Recado a equipe', 'Ver recados por setor'],
  ['recado-equipe.editar', 'Recado a equipe', 'Editar recados por setor'],
  ...
  ['quadrante.editar', 'Quadrante', 'Ordenar setores do quadrante'],
...
const defaultProfiles = [
  ...
  },
  {
    ...
    permissions: permissionIds.filter((id) => !['usuarios.excluir', 'cursista-epc.ver'].includes(id)),
  },
  {
