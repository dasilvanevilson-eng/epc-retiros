...
As substituições criam uma nova versão e não removem objetos anteriores. Qualquer limpeza futura do bucket deve ser precedida de auditoria, backup e autorização explícita.
