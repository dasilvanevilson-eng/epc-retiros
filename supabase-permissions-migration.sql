...
with permission_seed(id) as (
  values
    ...
    ('cursista.ver'),('cursista.criar'),('cursista.editar'),('cursista.excluir'),('cursista-smp.ver'),('cursista-epc.ver'),
...
profile_seed(perfil_id, permissao_id, permitido) as (
  ...
  union all
  select 'coordenador_geral', id, id not in ('usuarios.excluir', 'cursista-smp.ver', 'cursista-epc.ver') from permission_seed
  union all
