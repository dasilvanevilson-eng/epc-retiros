...
assert.match(retreatDetailSource, /Cozinha visualiza também cursistas e crianças no Espaço Kids com intolerância alimentar/, 'A descrição deve explicar a visualização especial da Cozinha.');
