...
const sectors = ['Animacao', 'Camareiros(as)', 'Casal Bem-estar', 'Coordenacao do retiro', 'Coordenacao geral', 'Cozinha', 'Data Show', 'Enfermaria', 'Espaco Kids', 'Espiritual', 'Externo', 'Folclore', 'Jovem de sala', 'Ligacao', 'Recreacao', 'Refeitorio', 'Secretaria', 'Zeladoria']
