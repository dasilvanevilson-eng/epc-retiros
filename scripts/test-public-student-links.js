...
assert.match(publicPage, /src="\/adminApp\.js\?v=20260806-icone-informacao-legivel"/, 'O acesso público deve carregar a mesma aplicação de formulário usada no acesso logado.');
