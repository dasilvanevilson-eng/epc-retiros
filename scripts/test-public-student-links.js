...
assert.match(publicPage, /src="\/adminApp\.js\?v=20260806-ajuda-links-cursistas"/, 'O acesso público deve carregar a mesma aplicação de formulário usada no acesso logado.');
