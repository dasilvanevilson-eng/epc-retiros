...
assert.doesNotMatch(appSource, /data-badge-sector-model-search|Buscar modelo de crach&aacute;/, 'A defini̤̣o deve exibir somente o seletor de modelo.');
assert.match(appSource, /<strong>Selecionar modelo<\/strong>/);
