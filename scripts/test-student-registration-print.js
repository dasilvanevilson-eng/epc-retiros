...
assert.match(printSource, /\.print-smp-common-grid \.print-field:nth-child\(5\)\{grid-column:1\}/, 'O campo Apresentante deve iniciar uma nova linha na impressão SMP.');
