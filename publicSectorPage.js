...
<html lang="pt-BR">
  ...
  <body>
    <section class="sector-public-modal" role="dialog" aria-modal="true" aria-labelledby="sector-title">
      ...
      ${showIntoleranceView ? '<div class="sector-public-tabs" role="tablist" aria-label="Visualiza&ccedil;&atilde;o do acompanhamento"><button type="button" id="sector-tab-entries" role="tab" aria-selected="true" aria-controls="sector-view-entries">Ades&otilde;es do setor</button><button type="button" id="sector-tab-intolerances" role="tab" aria-selected="false" aria-controls="sector-view-intolerances" tabindex="-1">Intoler&acirc;ncias dos cursistas</button></div>' : ''}
