...
1. Registre as contagens de `retiros`, `adesoes`, `cursistas`, `pessoas`, `casais` e `comunidades`.
2. Execute `supabase-financeiro-migration.sql` no SQL Editor.
3. Confirme novamente as mesmas contagens antes de liberar o menu Financeiro.
