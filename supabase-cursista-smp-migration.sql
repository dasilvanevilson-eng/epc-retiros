...
comment on table public.cursista_smp is 'Ficha de casal exclusiva da opcao Cursista SMP.';
comment on column public.cursista_smp.id is 'Numero da ficha, exclusivo dentro do retiro.';
comment on column public.cursista_smp.retiro_id is 'Retiro ao qual a ficha pertence. O retiro deve estar configurado com tipoFichaCursista = cursista-smp.';
